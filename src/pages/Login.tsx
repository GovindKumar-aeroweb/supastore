  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      ...
      <div className="hidden lg:block relative w-1/2 overflow-hidden">
        ...
        <img
          src="https://images.unsplash.com/photo-1587049352847-4d4b126a51ce?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
          alt="Honey dripping"
        ...
        <div className="absolute bottom-12 left-12 right-12 z-30 text-white">
          <h2 className="text-4xl font-serif font-bold mb-4">Welcome Back to the Hive</h2>
          <p className="text-lg text-[#fdfbf7]/90">Sign in to access your sweet rewards, track your orders, and discover new golden treasures.</p>
        </div>
      </div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-10 space-y-6" onSubmit={handleLogin}>
            ...
            <div className="text-sm text-center mt-8">
              ...
              <Link to="/register" className="font-bold text-[#b8860b] hover:text-[#a0740a] transition-colors">
                Register now
              </Link>
            </div>
          </form>
